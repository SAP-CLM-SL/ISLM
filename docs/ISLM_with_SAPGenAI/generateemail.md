...
**Explanation of the report:** In the report, ABAP AI SDK APIs are used to execute the prompts maintained in your intelligent scenario. <br>
...
- The prompts are executed using gpt-5-mini model.
...
3. In the dialog enter the below details and click the **Save** button. <br>
- Title: `Generate confirmation email for sales order`
- Select the **Type** as `Executable program`.
- Change the **Status** to `Test program`.
   ![](./images/PSave.png)

4. Click the **Local Object** button in the **Create Object Directory Entry** dialog.
   ![](./images/RPackage.png)

5. In the editor, paste the below code. Change the intelligent scenario name in the report to the scenario that you have created, where ### is your attendee id.
```
...
Well done, you have successfully queried the **gpt-5-mini** model to generate the confirmation email for sales order.

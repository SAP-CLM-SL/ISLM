...
- Add the S/4HANA system to SAP Logon
  ...
  ![Intelligent Scenarios](Gettingstarted/images/Connection.png)
  - Select **User Specified System** and click **Next**.<br>
  ![Intelligent Scenarios](Gettingstarted/images/UserSpecifiedSystem.png)
  - Enter system details, refer cheat_sheet (if required) and click **Next**.<br>
  ![Intelligent Scenarios](Gettingstarted/images/SystemDetails.png)
  - Click **Next** and **Finish**.
  - System should be visible on SAP Logon.
  ![Intelligent Scenarios](Gettingstarted/images/CAL.png)
